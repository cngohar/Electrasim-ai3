...
(() => {
  ...
  /* ── Node graph ────────────────────────────────────────────────────────── */
  const NODES = [
    [0.07, 0.15], [0.16, 0.15], [0.30, 0.15], [0.50, 0.15], [0.68, 0.15], [0.84, 0.13], [0.95, 0.15],
    [0.07, 0.40], [0.16, 0.40], [0.30, 0.40], [0.50, 0.40], [0.68, 0.40], [0.84, 0.40], [0.95, 0.40],
    [0.07, 0.54], [0.16, 0.54], [0.30, 0.54], [0.50, 0.54], [0.68, 0.54], [0.84, 0.54], [0.95, 0.54],
    [0.07, 0.76], [0.16, 0.76], [0.30, 0.76], [0.50, 0.76], [0.68, 0.76], [0.84, 0.76], [0.95, 0.76],
    [0.07, 0.92], [0.30, 0.92], [0.50, 0.92], [0.68, 0.92], [0.95, 0.92],
  ];
  ...
  const draw = (animate) => {
    ...
    for (let i = 0; i < NODES.length; i++) {
      ...
      ctx.fillStyle = g > 0.1 ? `rgba(255,184,0,${0.4 + g * 0.6})` : isLamp ? palette.nodeLamp : palette.node;
      ctx.fill();
    }
